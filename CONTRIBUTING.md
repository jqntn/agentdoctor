...
Do not add tool-attribution trailers (`Co-Authored-By` for an assistant, "generated by"
notes). If a human genuinely co-authored a commit, a `Co-Authored-By` line naming them is
welcome.
