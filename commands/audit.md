...
Run `npx agentdoctor . --no-user --json` and follow the config-audit skill's fix loop: for
...
Verify with `npx agentdoctor . --no-user --quiet` and report the grade before and after,
